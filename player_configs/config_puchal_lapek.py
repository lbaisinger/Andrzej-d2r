...
# hp/mana bar
hp_pool_potek_cv = (699, 25, 699+20, 25+20)
mana_pool_potek_cv = (1022, 25, 1022+20, 25+20)
hp_pool_exura_cv = (898, 25, 898+20, 25+20)
burn_mana_cv = (968, 25, 968+20, 25+20)

# battle window
#bw_cv = (4572, 887, 4572+150, 887+130)
bw_cv = (1746, 462, 1746+75, 462+65)
#bw_2nd_cv = (4572, 928, 4572+150, 928+130)
bw_2nd_cv = (1746, 488, 1746+75, 488+65)
#bw_full = (4572, 887, 4572+150, 887+130) # 130
bw_full = (1746, 462, 1746+75, 462+65) # 130
#redbox_cv = (4567, 882, 4567+50, 882+150)
redbox_cv = (1744, 462, 1744+40, 462+170)
#redbox_cv_1st = (4567, 882, 4567+50, 882+50)
redbox_cv_1st = (1744, 462, 1744+25, 462+75)

# minimap
#minimap_center_cv = (4675, 115, 4675+20, 120+15)
minimap_center_cv = (1795, 74, 1795+20, 74+20)
...
minimap_cv = (1750, 35, 1750+100, 35+100)

#ring_cv = (4583, 424, 4583+70, 424+70) # 40 35
ring_cv = (1750, 255, 1750+35, 255+35)
#amulet_cv = (4598, 440, 4598+70, 440+70) # 40 40
amulet_cv = (1750, 244, 1750+40, 244+40)
...
hotkey_yes = 'f12'
is_co_bic_custom_confidence = 0.99
